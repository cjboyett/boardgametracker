...
public class AddGamePlayPlayersController extends BaseController {
	private View view;
...
//	private boolean initializing = true;
	...
	protected void onAttach(@NonNull View v) {
		...
		addPlayerView = new AddPlayerView(getActivity());
...
//				initializing = false;
	...
	public List<GamePlayerData> getPlayerData() {
		...
		for (AddPlayerView view : playerViews.values()) {
			...
			else if (name.equals(Preferences.getUsername(getActivity()))) name = "master_user";
