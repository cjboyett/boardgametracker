...
{
	public static int totalTimePlayed(GamesDbHelper dbHelper, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
		int timePlayed = 0;
	...
	public static int totalTimePlayedWithPlayer(GamesDbHelper dbHelper, String playerName, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
		int timePlayed = 0;
		if (useBoardGamesForStats) timePlayed += BoardGameStatsDbUtility.totalTimePlayedWithPlayer(dbHelper, playerName);
		if (useRPGsForStats) timePlayed += RPGStatsDbUtility.totalTimePlayedWithPlayer(dbHelper, playerName);
		if (useVideoGamesForStats) timePlayed += VideoGameStatsDbUtility.totalTimePlayedWithPlayer(dbHelper, playerName);
		return timePlayed;
	}

	public static int timesPlayed(GamesDbHelper dbHelper, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
		int timesPlayed = 0;
	...
	public static int timesPlayedWithPlayer(GamesDbHelper dbHelper, String playerName, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
		int timesPlayed = 0;
	...
	public static int getNumberGamesPlayed(GamesDbHelper dbHelper, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
		int timesPlayed = 0;
	...
	public static List<GamePlayData> getGamePlaysWithPlayer(GamesDbHelper dbHelper, String playerName, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
		List<GamePlayData> gamePlayDataList = new ArrayList<>();

		if (useBoardGamesForStats)
		{
			List<GamePlayData> boardGamePlayDataList = BoardGameStatsDbUtility.getGamePlaysWithPlayer(dbHelper, playerName);
		...
		{
			List<GamePlayData> videoGamePlayDataList = VideoGameStatsDbUtility.getGamePlaysWithPlayer(dbHelper, playerName);
	...
	public static Map<Integer, List<String>> getAllGamesByTimesPlayed(GamesDbHelper dbHelper, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
		Log.d("Getting games", "BG " + useBoardGamesForStats + ", RPG " + useRPGsForStats + ", VG " + useVideoGamesForStats);
	...
	public static Map<Integer, List<String>> getAllGamesByTimePlayed(GamesDbHelper dbHelper, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
		Map<Integer, List<String>> allGames = new TreeMap<>();
	...
	public static Map<Integer, List<String>> getAllGamesByTimePlayedWithType(GamesDbHelper dbHelper, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
		Map<Integer, List<String>> allGames = new TreeMap<>();
		...
		if (useBoardGamesForStats)
		{
			...
			Map<Integer, List<String>> boardGamesTimesPlayed = BoardGameStatsDbUtility.getAllGamesByTimesPlayed(dbHelper);
		...
		if (useVideoGamesForStats)
		{
			...
			Map<Integer, List<String>> videoGamesTimesPlayed = VideoGameStatsDbUtility.getAllGamesByTimesPlayed(dbHelper);
	...
	public static Map<Integer, List<String>> getAllPlayersByTimesPlayed(GamesDbHelper dbHelper, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
	...
	public static Map<Integer, List<String>> getAllPlayersByTimePlayed(GamesDbHelper dbHelper, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
		Map<Integer, List<String>> allPlayers = new TreeMap<>();
		Map<String, Integer> boardGamePlayers = null, rpgPlayers = null, videoGamePlayers = null;
	...
	public static Map<String, Integer> getAllWonGames(GamesDbHelper dbHelper, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
...
//		Map<Integer, List<String>> rpgs = RPGStatsDbUtility.getAllGamesByTimesPlayed(dbHelper);
	...
	public static Map<String, Integer> getAllPlayersGamesLost(GamesDbHelper dbHelper, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
	...
	public static int getNumberOfGamesInCollection(GamesDbHelper dbHelper, boolean useBoardGamesForStats, boolean useRPGsForStats, boolean useVideoGamesForStats)
	{
		int count = 0;
