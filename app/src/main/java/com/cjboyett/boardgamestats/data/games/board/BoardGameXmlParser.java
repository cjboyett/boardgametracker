...
public class BoardGameXmlParser
{
	...
	private int readYearPublished(XmlPullParser parser)
	{
		int yearPublished = 0;

		try
		{
			parser.require(XmlPullParser.START_TAG, namespace, "yearpublished");
	...
	{
		public final int id, yearPublished;
		public final String name, thumbnailUrl, description;
		public final List<String[]> links;

		public Item(int id, String name, String thumbnailUrl, String description, int yearPublished, List<String[]> links)
		{
			this.id = id;
			this.name = name;
