...
public class VideoGameXmlParser
{
	...
	{
		int id = 0;
		String name = null, thumbnailUrl = null, description = null, releaseDate = null;
			...
			while (parser.next() != XmlPullParser.END_TAG)
			{
				...
				switch (entryName)
				{
					...
					case "description":
						...
						break;
					case "releasedate":
						releaseDate = readReleaseDate(parser);
						break;
					case "link":
	...
	private String readReleaseDate(XmlPullParser parser)
	{
		String releaseDate = null;
		try
		{
			parser.require(XmlPullParser.START_TAG, namespace, "releasedate");
			releaseDate = parser.getAttributeValue(null, "value");
			parser.nextTag();
	...
	{
		public final int id;
		public final String name, thumbnailUrl, description, releaseDate;
		public final List<String[]> links;

		public Item(int id, String name, String thumbnailUrl, String description, String releaseDate, List<String[]> links)
		{
			this.id = id;
			this.name = name;
