...
public class BoardGameStatsDbUtility
{
	public static String getRandomBlurb(GamesDbHelper dbHelper, String game)
	{
		...
		switch (i)
		{
			...
			// Times won
			case 1:
				int timesWon = getTimesWon(dbHelper, game);
				blurb = "<b>Times won:</b><br/>" + timesWon + " win" + (timesWon != 1 ? "s" : "");
				break;
			// Last time played
			case 2:
			...
			// Most lost against
			case 4:
				String mostLostPlayer = getMostLostToPlayer(dbHelper, game);
				if (mostLostPlayer != null)
					blurb = "<b>Most wins:</b><br/>" + mostLostPlayer;
				else
					blurb = "<b>You have never lost to another player.</b>";
				break;
			// Time played
			case 5:
