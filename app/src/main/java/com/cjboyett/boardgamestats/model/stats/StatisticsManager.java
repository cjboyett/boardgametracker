...
public class StatisticsManager
{
	...
	public int getGamesTimesPlayed()
	{
		if (gamesTimesPlayed == -1)
		{
			...
			gamesTimesPlayed = GameStatsDbUtility.timesPlayed(dbHelper, useBoardGamesForStats, useRPGsForStats, useVideoGamesForStats);
			dbHelper.close();
		}
	...
	public int getNumberGamesPlayed()
	{
		...
		{
			GamesDbHelper dbHelper = new GamesDbHelper(context);
			numberGamesPlayed = GameStatsDbUtility.getNumberGamesPlayed(dbHelper, useBoardGamesForStats, useRPGsForStats, useVideoGamesForStats);
			dbHelper.close();
		}
	...
	public int getGameTimePlayed()
	{
		...
		{
			GamesDbHelper dbHelper = new GamesDbHelper(context);
			totalGameTimePlayed = GameStatsDbUtility.totalTimePlayed(dbHelper, useBoardGamesForStats, useRPGsForStats, useVideoGamesForStats);
			dbHelper.close();
		}
	...
	public int getNumberGamePlaysPlayed()
	{
		...
		{
			GamesDbHelper dbHelper = new GamesDbHelper(context);
			numberGamePlaysPlayed = GameStatsDbUtility.timesPlayed(dbHelper, useBoardGamesForStats, useRPGsForStats, useVideoGamesForStats);
			dbHelper.close();
		}
	...
	public Map<Integer, List<String>> getAllGamesByTimesPlayed()
	{
		...
		{
			GamesDbHelper dbHelper = new GamesDbHelper(context);
			allGamesByTimesPlayed = GameStatsDbUtility.getAllGamesByTimesPlayed(dbHelper, useBoardGamesForStats, useRPGsForStats, useVideoGamesForStats);
			dbHelper.close();
		}
	...
	public Map<Integer, List<String>> getAllGamesByTimePlayed()
	{
		...
		{
			GamesDbHelper dbHelper = new GamesDbHelper(context);
			allGamesByTimePlayed = GameStatsDbUtility.getAllGamesByTimePlayed(dbHelper, useBoardGamesForStats, useRPGsForStats, useVideoGamesForStats);
			dbHelper.close();
		}
	...
	public Map<Integer, List<String>> getAllGamesByAverageTimePlayedWithType()
	{
		...
		{
			GamesDbHelper dbHelper = new GamesDbHelper(context);
			allGamesByAverageTimePlayedWithType = GameStatsDbUtility.getAllGamesByTimePlayedWithType(dbHelper, useBoardGamesForStats, useRPGsForStats, useVideoGamesForStats);
			dbHelper.close();
		}
	...
	public Map<Integer, List<String>> getAllPlayersByTimesPlayed()
	{
		...
		{
			GamesDbHelper dbHelper = new GamesDbHelper(context);
			allPlayersByTimesPlayed = GameStatsDbUtility.getAllPlayersByTimesPlayed(dbHelper, useBoardGamesForStats, useRPGsForStats, useVideoGamesForStats);
			dbHelper.close();
		}
	...
	public Map<Integer, List<String>> getAllPlayersByTimePlayed()
	{
		...
		{
			GamesDbHelper dbHelper = new GamesDbHelper(context);
			allPlayersByTimePlayed = GameStatsDbUtility.getAllPlayersByTimePlayed(dbHelper, useBoardGamesForStats, useRPGsForStats, useVideoGamesForStats);
			dbHelper.close();
		}
	...
	public Map<String, Integer> getNumberWonGames()
	{
		...
		{
			GamesDbHelper dbHelper = new GamesDbHelper(context);
			allWonGames = GameStatsDbUtility.getAllWonGames(dbHelper, useBoardGamesForStats, useRPGsForStats, useVideoGamesForStats);
			dbHelper.close();
		}
		return allWonGames;
	}
	...
	public Map<String, Integer> getAllPlayersGamesLost()
	{
		...
		{
			GamesDbHelper dbHelper = new GamesDbHelper(context);
			allLostPlayers = GameStatsDbUtility.getAllPlayersGamesLost(dbHelper, useBoardGamesForStats, useRPGsForStats, useVideoGamesForStats);
			dbHelper.close();
		}
	...
	public int getNumberOfGames()
	{
		...
		{
			GamesDbHelper dbHelper = new GamesDbHelper(context);
			numberOfGames = GameStatsDbUtility.getNumberOfGamesInCollection(dbHelper, useBoardGamesForStats, useRPGsForStats, useVideoGamesForStats);
			dbHelper.close();
		}
