...
import static com.cjboyett.boardgamestats.model.Date.APRIL;
import static com.cjboyett.boardgamestats.model.Date.MAY;
import static com.cjboyett.boardgamestats.model.Date.NOVEMBER;
...
public class ChangeLog {
	...
	public static LogEntry[] entries = {
			new LogEntry("1.2.0", "Began implementing new navigation framework\n" +
					"Began updating UI to match material design standards:\n" +
					"-Added toolbar\n" +
					"-Added menu drawer\n" +
					"Major bugfix from thumbnails not loading", new Date(2017, MAY, 30)),
			new LogEntry("1.1.0", "Major update:\n" +
					"UI overhaul\n" +
					"Player avatars\n" +
			...
			new LogEntry("1.0.9b",
						 "Bug fix related to crash coming from ticker" +
								 "" /* Changed way most won games is handled */,
						 new Date(2016, MAY, 27)),
			...
			new LogEntry("1.0.4",
						 "Added ability to retrieve game play and collection data from Board Game Geek",
						 new Date(2016, APRIL, 18)),
			new LogEntry("1.0.3",
						 "Bug fixes, various tweaks, and UI improvements\n" +
								 "Added filtering of games in Collection and Game Plays",
						 new Date(2016, APRIL, 17)),
			new LogEntry("1.0.2",
						 "Added functionality to for role playing games and video games",
						 new Date(2016, APRIL, 13)),
