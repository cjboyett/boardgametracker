...
public class VideoGame extends Game
{
	...
	public static final int COMPILATION = 0, DEVELOPER = 1, FRANCHISE = 2, GENRE = 3, MODE = 4, PLATFORM = 5, PUBLISHER = 6, SERIES = 7, THEME = 8;
	...
	public static VideoGame createGame(VideoGameXmlParser.Item item)
	{
		...
		{
			if (extra[0].equals("videogamecompilation")) game.addCompilation(new VideoGameCompilation(extra[2], Integer.parseInt(extra[1])));
			else if (extra[0].equals("videogamedeveloper")) game.addDeveloper(new VideoGameDeveloper(extra[2], Integer.parseInt(extra[1])));
			else if (extra[0].equals("videogamefranchise")) game.addFranchise(new VideoGameFranchise(extra[2], Integer.parseInt(extra[1])));
			else if (extra[0].equals("videogamegenre")) game.addGenre(new VideoGameGenre(extra[2], Integer.parseInt(extra[1])));
			else if (extra[0].equals("videogamemode")) game.addMode(new VideoGameMode(extra[2], Integer.parseInt(extra[1])));
			else if (extra[0].equals("videogameplatform")) game.addPlatform(new VideoGamePlatform(extra[2], Integer.parseInt(extra[1])));
			else if (extra[0].equals("videogamepublisher")) game.addPublisher(new VideoGamePublisher(extra[2], Integer.parseInt(extra[1])));
			else if (extra[0].equals("videogameseries")) game.addSeries(new VideoGameSeries(extra[2], Integer.parseInt(extra[1])));
			else if (extra[0].equals("videogametheme")) game.addTheme(new VideoGameTheme(extra[2], Integer.parseInt(extra[1])));
		}
