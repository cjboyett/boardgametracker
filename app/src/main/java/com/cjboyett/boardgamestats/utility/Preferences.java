...
*/
	...
	public static boolean showNotifications(Context context) {
		SharedPreferences sharedPreferences = getSharedPreferences(context);
		return sharedPreferences.getBoolean(context.getString(R.string.allow_notifications_preference),
											true);// && !isSuperUser(context);
	}
	...
	public static boolean showReminder(Context context) {
		SharedPreferences sharedPreferences = getSharedPreferences(context);
		return sharedPreferences.getBoolean(context.getString(R.string.show_reminder),
											true);// && !isSuperUser(context);
	}
